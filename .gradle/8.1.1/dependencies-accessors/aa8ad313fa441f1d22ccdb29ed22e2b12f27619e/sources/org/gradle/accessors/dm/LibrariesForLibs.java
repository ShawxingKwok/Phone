...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final KtLibraryAccessors laccForKtLibraryAccessors = new KtLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at kt
     */
    public KtLibraryAccessors getKt() {
        return laccForKtLibraryAccessors;
    }
    ...
    public static class KtLibraryAccessors extends SubDependencyFactory {

        public KtLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
